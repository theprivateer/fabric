...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('publish_at', (! empty($article->publish_at)) ? $article->publish_at->format('j F Y') : null, ['class' => 'form-control', 'placeholder' => date('j F Y'), 'role' => 'datepicker']) !!}
                    </div>
                </div>
            </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                {!! Form::textarea('content[body]', null, ['class' => 'form-control', 'rows' => 18, 'role' => 'editor']) !!}
            </div>
        </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            @include('fabric::admin.layouts.partials.image-upload', ['model' => $article, 'field' => 'content[image_id]'])
